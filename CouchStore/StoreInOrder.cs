...
{
	public class SerializedCouchStoreEntry<T> : CouchStoreEntry<T> where T : class
	{
		public CouchTaskSerializeContext<T> SerializeContext { get; private set; }

		public SerializedCouchStoreEntry(string id, T entity, string json = null, bool overwrite = true, CouchStoreEventHandler<T> handler = null)
			: base(id, entity, json, overwrite, handler)
		{
		}
	}
